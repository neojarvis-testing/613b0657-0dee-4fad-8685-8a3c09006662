...
(async () => {
  ...
  await page.goto('https://8080-fcaaecbcafccfabfababbefafbdccaebfebeabacaeced.ide.exam.ly');
  ...
  await page1.goto('https://8081-fcaaecbcafccfabfababbefafbdccaebfebeabacaeced.ide.exam.ly');
